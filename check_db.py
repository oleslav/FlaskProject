...
if __name__ == '__main__':
    db.create_all()
    # user1 = User(username="Olaf", password="password")
    # user2 = User(username="Bengin", password="password")
    # user3 = User(username="Maira", password="password")
    #
    # tag1 = Tag(name='cook')
    # tag2 = Tag(name='music')
    #
    ...
    note1 = Note(text="Some text", user=user1)
    note2 = Note(text="Some text", user=user1)
